...
use App\Http\Controllers\Api\Public\AboutPageController as PublicAboutPageController;
use App\Http\Controllers\Api\Public\ActivityController as PublicActivityController;
use App\Http\Controllers\Api\Public\ConnectPageController as PublicConnectPageController;
...
use App\Http\Controllers\Api\Public\LegalPageController as PublicLegalPageController;
use App\Http\Controllers\Api\Public\NavigationFooterController as PublicNavigationFooterController;
use App\Http\Controllers\Api\Public\ProjectCategoryController as PublicProjectCategoryController;
use App\Http\Controllers\Api\Public\ProjectController as PublicProjectController;
use App\Http\Controllers\Api\Public\ReachOutPageController as PublicReachOutPageController;
...
use App\Http\Controllers\Api\Public\SeoController as PublicSeoController;
use App\Http\Controllers\Api\Public\TeamMemberController as PublicTeamMemberController;
use App\Http\Controllers\Api\Public\WebsiteSettingsController as PublicWebsiteSettingsController;
...
Route::prefix('public')->group(function () {
    ...
    Route::get('home', [PublicHomePageController::class, 'show']);
    Route::get('about', [PublicAboutPageController::class, 'show']);
    Route::get('navigation-footer', [PublicNavigationFooterController::class, 'show']);
    Route::get('connect', [PublicConnectPageController::class, 'show']);
    Route::get('website-settings', [PublicWebsiteSettingsController::class, 'show']);
    Route::get('reach-out', [PublicReachOutPageController::class, 'show']);
    Route::get('legal-pages', [PublicLegalPageController::class, 'index']);
    Route::get('legal-pages/{legalPage:slug}', [PublicLegalPageController::class, 'show']);
    Route::get('seo', [PublicSeoController::class, 'index']);
    Route::get('seo/by-route', [PublicSeoController::class, 'byRoute']);
    ...
    Route::get('projects/{categorySlug}/{slug}', [PublicProjectController::class, 'show']);
    Route::get('services', [PublicServiceController::class, 'index']);
    Route::get('activities', [PublicActivityController::class, 'index']);
    Route::get('activities/{activity:slug}', [PublicActivityController::class, 'show']);
    Route::get('team-members', [PublicTeamMemberController::class, 'index']);
    Route::get('careers', [PublicJobController::class, 'page']);
    Route::get('jobs', [PublicJobController::class, 'index']);
    Route::get('jobs/{job:slug}', [PublicJobController::class, 'show']);
    Route::get('search', [PublicSearchController::class, 'index']);
    Route::get('search/suggestions', [PublicSearchController::class, 'suggestions']);
});
