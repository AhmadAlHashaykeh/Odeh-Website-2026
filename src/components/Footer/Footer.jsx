...
const EXCLUDED_PATHS = new Set(['/privacy-policy', '/terms']);
...
function NavGroup({ title, links }) {
  ...
  return (
    <div className={styles.navGroup}>
      <h4 className={styles.navGroupTitle}>{title}</h4>
...
export default function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerTopRule} aria-hidden="true" />
      <div className={styles.bgGrid} aria-hidden="true">
        <div className={styles.bgGridDrift} />
      </div>
