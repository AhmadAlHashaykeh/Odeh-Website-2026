...
export const termsContent = {
  meta: {
    ...
    description:
      'Read the terms and conditions governing use of the ODEH & PARTNERS DESIGN website and related digital services.',
  },
  hero: {
    label: 'Legal',
    title: 'Terms & Conditions',
    description:
      'These terms govern your access to and use of the ODEH & PARTNERS DESIGN website and digital communications with our firm.',
