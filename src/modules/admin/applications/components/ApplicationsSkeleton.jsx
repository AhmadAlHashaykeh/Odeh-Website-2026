import styles from './ApplicationsSkeleton.module.css';
  ...
  return (
    <div className={styles.candidateCard}>
      ...
      <div className={styles.cardBody}>
        ...
        <Shimmer className={styles.jobShimmer} />
    ...
    <div className={styles.tableWrap}>
      {Array.from({ length: 8 }).map((_, i) => (
        <div key={i} className={styles.tableRow}>
          <Shimmer className={styles.checkboxShimmer} />
          <Shimmer className={styles.candidateShimmer} />
...
export default function ApplicationsSkeleton({
  ...
  return (
    <div className={styles.full} aria-busy="true" aria-label="Loading applications">
      <StatsSkeleton />
      <ToolbarSkeleton />
